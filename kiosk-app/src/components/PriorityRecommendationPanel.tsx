    ...
    <div className="space-y-5">
      <div className="overflow-hidden rounded-[28px] border border-[#ebe8fa] bg-white shadow-[0_12px_28px_rgba(108,81,233,0.08)]">
        <div className="bg-[#F3F4FF] px-5 py-4">
          <p className="text-sm font-semibold text-[#8e88b6]">已识别症状</p>
        </div>
        <div className="px-5 py-4">
          <p className="text-[20px] text-[#6d6889]">{props.symptom || "未提供"}</p>
          <p className="mt-2 text-[24px] font-bold text-[#2f2a45]">{props.department}</p>
      ...
      <div className="overflow-hidden rounded-[28px] border border-[#ebe8fa] bg-white shadow-[0_12px_28px_rgba(108,81,233,0.08)]">
        <div className="bg-[#F3F4FF] px-5 py-4">
          <p className="text-sm font-semibold text-[#8e88b6]">推荐医生</p>
        </div>
        <div className="px-5 py-4">
